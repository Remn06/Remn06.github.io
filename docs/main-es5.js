...
var DinoLivesComponent = /** @class */ (function (_super) {
    tslib__WEBPACK_IMPORTED_MODULE_0__["__extends"](DinoLivesComponent, _super);
    ...
    DinoLivesComponent.prototype.start = function () {
        var rootGameObject = _business_core_game_object_collection__WEBPACK_IMPORTED_MODULE_7__["GameObjectCollection"].root(this.gameObject);
